...
const demoScript = [
  {
    ...
    name: '旁白',
    content:
      '揭阳学宫的大殿内，阳光透过雕花窗棂洒在青石板上，空气中弥漫着古木的香气。这是一座见证了百年历史的文庙，承载着无数读书人的梦想与希望。现在，新的故事即将在这里展开...',
  },
  {
    id: 'avg_2',
    ...
    content:
      '年轻人，我看你气宇不凡，眉宇间透着一股正气。能来这揭阳学宫，想必是对儒学文化有所向往。说吧，今日来此有何贵干？',
  },
  {
    id: 'avg_3',
    ...
    content:
      '林先生，晚辈陈灵儿，现任揭阳学宫捕快。我今日前来，是想向您打听儒学文脉印章的下落。这枚印章关系重大，它与我父母多年前失踪的真相息息相关。',
  },
  {
    id: 'avg_4',
    speakerType: 'npc' as const,
    ...
    avatar: 'npcs/lin_wenyuan.webp',
    content:
      '原来如此。儒学文脉印章确实在我这里保管，但这并非寻常之物。它承载着揭阳文脉的传承，想要得到它，必须证明你有足够的学识和对传统文化的敬畏之心。',
  },
  {
    id: 'avg_5',
    speakerType: 'npc' as const,
    ...
    avatar: 'npcs/lin_wenyuan.webp',
    content:
      '印章确实在我这里保管，但这并非寻常之物。它承载着揭阳文脉的传承，想要得到它，必须证明你有足够的学识和对传统文化的敬畏之心。请选择你的下一步行动：',
    options: [
      ...
      {
        label: '请求林先生讲述更多关于揭阳学宫的古老传说和有趣故事',
        value: 'request_stories',
      },
    ],
  },
  {
    ...
    name: '旁白',
    content:
      '一场考验即将开始。这不仅仅是对知识的测试，更是对内心的检验。印章的背后，隐藏着更多不为人知的秘密...',
  },
]

const demoBgImage = 'locations/confucian_temple_bg.webp'
