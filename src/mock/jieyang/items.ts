...
export const seals: Seal[] = [
  {
    ...
    icon: IMG_HOST + 'seals/seal_one_icon.webp',
    fullImage: IMG_HOST + 'seals/seal_one_icon.webp',
  ...
  },
  {
    ...
    icon: IMG_HOST + 'seals/seal_two_icon.webp',
    fullImage: IMG_HOST + 'seals/seal_two_icon.webp',
  ...
  },
  {
    ...
    icon: IMG_HOST + 'seals/seal_three_icon.webp',
    fullImage: IMG_HOST + 'seals/seal_three_icon.webp',
  ...
  },
  {
    ...
    icon: IMG_HOST + 'seals/seal_four_icon.webp',
    fullImage: IMG_HOST + 'seals/seal_four_icon.webp',
  ...
  //   icon: IMG_HOST + 'seals/seal_three_fake_icon.webp',
  //   fullImage: IMG_HOST + 'seals/seal_three_fake_icon.webp',
  ...
  // },
  {
    ...
    icon: IMG_HOST + 'seals/laoye_baohao_icon.webp',
    fullImage: IMG_HOST + 'seals/laoye_baohao_icon.webp',
...
export const clues: Clue[] = [
  ...
  },
  {
    ...
    icon: IMG_HOST + 'clues/clue.webp', // 临时修复：使用已存在的图标
    source: '玩家调查发现',
    location: 'jieyang_confucian_temple',
...
export const items: Item[] = [
  {
    ...
    icon: IMG_HOST + 'items/badge.webp',
    type: 'identity',
    inspectable: true,
  ...
  // 🎒 新增：关键印章的实体道具版本
  {
    ...
    icon: IMG_HOST + 'seals/seal_one_icon.webp', // 复用印章图标
    type: 'heirloom',
    inspectable: true,
    inspectText:
      '印章侧面有断裂的凹槽，似乎需要和其他印章拼接。这个发现很重要！',
  ...
  },
  {
    ...
    icon: IMG_HOST + 'seals/seal_three_icon.webp', // 复用伪造印章图标
    type: 'evidence',
    inspectable: true,
    inspectText:
      '奇怪...这枚印章侧面非常光滑，没有任何拼接用的凹槽！这是个赝品！蔡福生在欺骗我！',
    relatedClueId: 'clue_fake_seal',
    // 标记为关键证物
    isEvidence: true,
