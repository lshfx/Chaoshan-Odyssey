...
export const storyEndings: StoryEnding[] = [
  // 🌟 结局一：完美结局 (云开月明)
  {
    ...
    imageUrl: '/static/endings/chen_perfect.jpg'
  },
  ...
  // 🛡️ 结局二：普通结局 (古城守夜人)
  {
    ...
    title: '古城守夜人',
    achievement: '孤单的守望者',
    description: '蔡福生因伪造信物被捕入狱，但他死咬着不松口。因为缺乏关键证据，你无法得知父母的生死。',
    background: '你选择继续留在揭阳古城，做一名捕快，日夜守望着进贤门，期待有一天能等到那个或许永远不会回来的消息。',
    conditions: {
      minClue: 2
      // 对应MD：策略B（言语周旋），证据链不完整
    },
    imageUrl: '/static/endings/chen_normal.jpg'
  },
  ...
  // 🌧️ 结局三：悲剧结局 (雨夜孤影)
  {
    ...
    title: '雨夜孤影',
    achievement: '迷途捕快',
    description: '火盆里的纸张化为灰烬。蔡福生狂笑着：“烧了！都烧了！你爹娘的消息，这辈子你也别想知道！”',
    background: '线索断了。你站在满地狼藉的侨批馆里，窗外下起了大雨，就像二十年前那个夜晚一样。你赢了局，却输了家。',
    conditions: {
      // 对应MD：策略C（犹豫不决）或 果敢度过低
      maxCourage: 0 
    },
    imageUrl: '/static/endings/chen_bad.jpg'
  },
  ...
  // 🥚 隐藏结局 (南洋茶局)
  {
    ...
    title: '南洋茶局',
    achievement: '大智若愚',
    description: '一句“老爷保号”唤醒了良知。蔡福生崩溃痛哭，主动交出了所有东西。你没有抓他，而是让他去南洋送信。',
    background: '多年后，你在揭阳开了一家茶馆，父母虽年迈但已归来，一家人围炉煮茶，听雨声。',
    conditions: {
      minIntimacy: 10,
      // 对应MD：全程不动武，且触发暗语
      requiredFlags: ['peaceful_resolution']
    },
    imageUrl: '/static/endings/chen_hidden.jpg'
  }
];
